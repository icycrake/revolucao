		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busca Imagens",
									"targetURL": "#thiagoimagesearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"thiagoimagesearch-display": {
								"semanticObject": "thiagoimagesearch",
								"action": "display",
								"description": "Busca Imagens",
								"title": "Busca Imagens",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=thiago.imagesearch",
									"url": sap.ui.require.toUrl("thiago/imagesearch")
								}
							}
						}
					}
